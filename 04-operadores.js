...
console.log("--------------------------------------------");
console.log("x =", x, "| y =", y);
console.log("x e igual a y?", x == y); //comparação de igualdade
console.log("x e diferente de y?", x != y); //diferente de 
...
console.log("--------------------------------");
console.log("x =", x, "| y =", y);
console.log("x é igual a y?", x == y); //comparação de iguald
